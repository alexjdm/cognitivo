        ...
        <div class="modal-body">
            ...
            <div class="editor">
                ...
                <div class="editor-field">
                    <input type="password" id="CLAVE_EMPLEADO" class="form-control" autocomplete="off">
                </div>
            </div>
            <div class="editor">
                <div class="editor-label" style="width:200px">
                ...
                <div class="editor-field">
                    <input type="password" id="CLAVE_EMPLEADO2" class="form-control" autocomplete="off">
                </div>
            </div>
