...
<html lang="es">
	...
	<body data-spy="scroll" data-target=".navbar-collapse">
		...
		<section id="gallery non-display-responsive">
			<div class="container">
				<div class="row text-center">
					<div class="col-sm-12">
						...
						<ul class="gallery">
							<li class="col-sm-3 col-xs-6">
								<a href="images/centro/Cognitivo-Espacios-terapeuticos-2.jpg" class="fancybox" data-fancybox-group="group" title="">
									<img src="images/centro/Cognitivo-Espacios-terapeuticos-kids-2.jpg" alt="Centro Cognitivo Espacios terapéuticos" title="Espacios terapéuticos" class="img-responsive" />
									<div><i class="fa fa-search fa-3x"></i></div>
								</a>
							</li>
							<li class="col-sm-3 col-xs-6">
								<a href="images/centro/Cognitivo-Espacios-terapeuticos-4.jpg" class="fancybox" data-fancybox-group="group" title="">
									<img src="images/centro/Cognitivo-Espacios-terapeuticos-kids-4.jpg" alt="Centro Cognitivo Espacios terapéuticos" title="Espacios terapéuticos" class="img-responsive" />
									<div><i class="fa fa-search fa-3x"></i></div>
								</a>
							</li>
							<li class="col-sm-3 col-xs-6">
								<a href="images/centro/Cognitivo-Espacios-terapeuticos-10.jpg" class="fancybox" data-fancybox-group="group" title="">
									<img src="images/centro/Cognitivo-Espacios-terapeuticos-kids-10.jpg" alt="Centro Cognitivo Espacios terapéuticos" title="Espacios terapéuticos" class="img-responsive" />
									<div><i class="fa fa-search fa-3x"></i></div>
								</a>
							</li>
							<li class="col-sm-3 col-xs-6">
								<a href="images/centro/Cognitivo-Espacios-terapeuticos-28.jpg" class="fancybox" data-fancybox-group="group" title="">
									<img src="images/centro/Cognitivo-Espacios-terapeuticos-kids-28.jpg" alt="Terapia Ocupacional" title="Terapia Ocupacional" class="img-responsive" />
									<div><i class="fa fa-search fa-3x"></i></div>
								</a>
							</li>
							<li class="col-sm-3 col-xs-6">
								<a href="images/centro/Cognitivo-Espacios-terapeuticos-30.jpg" class="fancybox" data-fancybox-group="group" title="">
									<img src="images/centro/Cognitivo-Espacios-terapeuticos-kids-30.jpg" alt="Terapia Ocupacional" title="Terapia Ocupacional" class="img-responsive" />
									<div><i class="fa fa-search fa-3x"></i></div>
								</a>
							</li>
							<li class="col-sm-3 col-xs-6">
								<a href="images/centro/Cognitivo-Espacios-terapeuticos-32.jpg" class="fancybox" data-fancybox-group="group" title="">
									<img src="images/centro/Cognitivo-Espacios-terapeuticos-kids-32.jpg" alt="Terapia Ocupacional" title="Terapia Ocupacional" class="img-responsive" />
									<div><i class="fa fa-search fa-3x"></i></div>
								</a>
							</li>
							<li class="col-sm-3 col-xs-6">
								<a href="images/centro/Cognitivo-Espacios-terapeuticos-46.jpg" class="fancybox" data-fancybox-group="group" title="">
									<img src="images/centro/Cognitivo-Espacios-terapeuticos-kids-46.jpg" alt="Terapia Fonoaudiologica" title="Terapia Fonoaudiologica" class="img-responsive" />
									<div><i class="fa fa-search fa-3x"></i></div>
								</a>
							</li>
							<li class="col-sm-3 col-xs-6">
								<a href="images/centro/Cognitivo-Espacios-terapeuticos-50.jpg" class="fancybox" data-fancybox-group="group" title="">
									<img src="images/centro/Cognitivo-Espacios-terapeuticos-kids-50.jpg" alt="Terapia Social" title="Terapia social" class="img-responsive" />
									<div><i class="fa fa-search fa-3x"></i></div>
								</a>
							</li>
							<li class="col-sm-3 col-xs-6">
								<a href="images/centro/Cognitivo-Espacios-terapeuticos-55.jpg" class="fancybox" data-fancybox-group="group" title="">
									<img src="images/centro/Cognitivo-Espacios-terapeuticos-kids-55.jpg" alt="Terapia ocupacional" title="Terapia Ocupacional" class="img-responsive" />
									<div><i class="fa fa-search fa-3x"></i></div>
								</a>
							</li>
							<li class="col-sm-3 col-xs-6">
								<a href="images/centro/Cognitivo-Espacios-terapeuticos-59.jpg" class="fancybox" data-fancybox-group="group" title="">
									<img src="images/centro/Cognitivo-Espacios-terapeuticos-kids-59.jpg" alt="Terapia Psicopedagogica" title="Terapia Psicopedagogica" class="img-responsive" />
									<div><i class="fa fa-search fa-3x"></i></div>
								</a>
							</li>
							<li class="col-sm-3 col-xs-6">
								<a href="images/centro/Cognitivo-Espacios-terapeuticos-81.jpg" class="fancybox" data-fancybox-group="group" title="">
									<img src="images/centro/Cognitivo-Espacios-terapeuticos-kids-81.jpg" alt="Terapia Fonoaudiologica" title="Terapia Fonoaudiologica" class="img-responsive" />
									<div><i class="fa fa-search fa-2x"></i></div>
								</a>
							</li>
							<li class="col-sm-3 col-xs-6">
								<a href="images/centro/Cognitivo-Espacios-terapeuticos-89.jpg" class="fancybox" data-fancybox-group="group" title="">
									<img src="images/centro/Cognitivo-Espacios-terapeuticos-kids-89.jpg" alt="Terapia Fonoaudiologica" title="Terapia Fonoaudiologica" class="img-responsive" />
									<div><i class="fa fa-search fa-2x"></i></div>
								</a>
							</li>
						</ul>
...
<!-- Superslides CSS -->
<link href="css/superslides.min.css" rel="stylesheet">
