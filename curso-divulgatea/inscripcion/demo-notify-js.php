...
if ($transaction_id == 'demo-js-transaction-1' && $response == 'VERIFIED' && $receiver_id == $my_receiver_id) {
	$headers = 'From: "Curso divulgaTEA" <no-responder@khipu.com>' . "\r\n";
	$headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
	$subject = 'Pago exitoso Curso divulgaTEA';
	$body = <<<EOF
Hola<br/>
<br/>
<p>
...
<br><br>Atentamente,<br>Equipo Cognitivo<br><img src='../../images/logo-hor.png'>
