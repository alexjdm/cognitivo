...
function khipu_get_new_payment($email, $bankId, $precio, $id_transaction) {
	...
	$subject = 'Inscripción Curso DivulgaTEA';
	$body = 'Este es un pago correspondiente a la inscripción del curso DivulgaTEA. Te enviaremos un correo de confirmación a penas validemos tu inscripción.';
	$bank_id = $bankId;
	$amount = $precio;
	$payer_email = $email;
	...
	$cancel_url = '';
	$picture_url = 'http://www.cognitivo.cl/images/logo-hor.png';
