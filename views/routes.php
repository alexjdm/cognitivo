...
$controllers = array(
    'home' => ['index', 'ados', 'equipo', 'condicionesplanes', 'capacitaciones',
        ...
        'cursoteamanejoconductascomplejassegundaversion', 'cursoteamanejoconductascomplejasprocesssegundaversion', 'cursoteamanejoconductascomplejasfinishsegundaversion', 'cursoteamanejoconductascomplejasnotifyjssegundaversion',
        ...
        'cursohabilidadesparentales', 'cursohabilidadesparentalesprocess', 'cursohabilidadesparentalesfinish', 'cursohabilidadesparentalesnotifyjs',
        'tallermanejoconductasinapropiadas', 'tallermanejoconductasinapropiadasprocess', 'tallermanejoconductasinapropiadasfinish', 'tallermanejoconductasinapropiadasnotifyjs',
        'juegoestrategiadeintervencion', 'juegoestrategiadeintervencionprocess', 'juegoestrategiadeintervencionfinish', 'juegoestrategiadeintervencionnotifyjs',
        'error'],
    'blog' => ['index', 'cuantotiempousochupete', 'fenomenocausaefectobebe', 'aporteterapeutaocupacional', 'queeslapsicopedagogia',
        ...
        'habilidadesparentales', 'manejoconductasinapropiadasdemihijo', 'teapirotecnia', 'mihijotienetea',
        'error'],
    ...
    'admin' => ['home',
        ...
        'enviarcorreomasivo',
        'profesionales',
        'newuser', 'createnewuser', 'useredit', 'edituser', 'deleteuser', 'passworduser', 'changepassworduser',
        'detallediario',
        'error'],
    'user' => ['index',  'fichas',
