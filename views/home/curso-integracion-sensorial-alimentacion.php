...
<header class="background background3 background-image">
    <div class="container">
        <div class="row text-center no-fade" style="opacity: 1;">
            <div class="col-sm-12">
                <h1>Curso "Integracion Sensorial y Alimentación"</h1>
            </div>
        </div>
    </div>
</header>
        ...
        <div class="text-center">
            ...
            <div class="row">
                <div class="col-md-12" style="padding-top: 30px;">
                    <p>Participa en nuestro curso para padres sobre integración sensorial y problemas en la alimentación de nuestros niños.</p>
                    <p>El curso será dictado por Noemí Iriarte, Terapeuta Ocupacional de Cognitivo con certificación en Integración Sensorial Ayres, cursos de especialización en alimentación: Sensorialidad Oral y Motricidad Oral, entre otras. Tambien nos acompañará Pamela Tapia certificada en Intervención en Integración Sensorial.</p>
                </div>
            </div>
            ...
            <div class="col-sm-12">
                ...
                <form class="form-horizontal" role="form" action="curso-integracion-sensorial-alimentacion-process/" method="post" onsubmit="document.getElementById('nombreBanco').value=document.getElementById('bankId').options[document.getElementById('bankId').selectedIndex].text;">
                    <div class="col-sm-6">
